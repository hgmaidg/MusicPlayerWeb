...
import { uploadSlice } from '../../redux/sliceReducer';
...
function Upload() {
    ...
    const handleCloseForm = () => {
        dispatch(uploadSlice.actions.setIsLogin(false));
    };
    ...
    const handleUpload = (e) => {
        ...
        const fetchLogin = async () => {
            ...
            try {
                ...
                dispatch(uploadSlice.actions.setDataUser(response.data));
                dispatch(uploadSlice.actions.setAccessToken(response.accessToken));
        ...
        <div className={cx('wrapper')}>
            <div className={cx('container_section')}>
                ...
                <form
                    ...
                    onSubmit={(e) => (isLoginForm ? handleUpload(e) : handleSubmit(e))}
                >
                    {isLoginForm ? (
                        ///////////////
                        /* Form Login */
